...
See also "/home/obinexus/obinexus/pkg/gov-std-web/build/CMakeFiles/CMakeOutput.log".
make: *** No targets specified and no makefile found.  Stop.
./refactor.sh: line 8: Or: command not found
make: *** No rule to make target 'debug'.  Stop.
make: *** No rule to make target 'test'.  Stop.
make: *** No rule to make target 'validate-manifest'.  Stop.
./refactor.sh: line 12: ./gov-refactor.sh:: No such file or direc
